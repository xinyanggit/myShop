	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
				location = "/myShop/sp/batchDelete?cartItemIds=" + id;
			}
		}else {
...
function batchDelete() {
	...
	location = "/myShop/sp/batchDelete?cartItemIds=" + cartItemIdArray;
}
...
<body>
	...
	<c:choose>
		...
		<c:otherwise>
			<table width="95%" align="center" cellpadding="0" cellspacing="0">
				...
				<c:forEach items="${cartItemList }" var="cartItem">
					<tr align="center">
						...
						<td><span>&yen;<span class="currPrice">${cartItem.phone.currprice
									}</span>
						</span>
						</td>
						...
						<td><a
							href="<c:url value='/sp/batchDelete?cartItemIds=${cartItem.cartItemId }'/>">删除</a>
						</td>
					</tr>
				</c:forEach>
			...
			<form id="jieSuanForm" action="<c:url value='/sp/loadCartItems'/>"
				method="post">
