...
<body>
	<div class="divContent">
		<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${order.total
			}</span> <span class="spanOid">编号：${order.oid }</span>
	</div>
	<form action="<c:url value='/sp/payment'/>" method="post" id="form1"
		target="_top">
		...
		<div class="divBank">
			...
			<div style="margin: 40px;">
				<a  href="javascript:void(0)" onclick="go_1()" class="linkNext" >下一步</a>
			</div>
		</div>
	</form>
</body>
