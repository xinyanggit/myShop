		...
		<div class="divContent">
			<div style="margin: 20px;">
				<img style="float: left; margin-right: 30px;"
					...
					style="font-size: 30px; color: #c30; font-weight: 900;">${msg
					}</span> <br /> <br /> <br /> <br /> <span style="margin-left: 50px;">
					<c:if test="${yes}">
					<a	target="_top" href="<c:url value='/jsps/user/login.jsp'/>">登录</a></c:if>
				</span> <span style="margin-left: 50px;"><a target="_top"
					href="<c:url value='/index.jsp'/>">返回主页</a>
				</span>
			</div>
		</div>
	</div>
