...
<script type="text/javascript"
	...
	<script type="text/javascript">
		...
		var timedata=(new Date()).getTime();
			...
			$("#imgVerifyCode").attr("src","<c:url value='/VerfyCode' />?"+timedata);
		}
	</script>
</head>

<body style="background-image: url('/myShop/images/'); width: 800;height: 600">
	<div id="divMain">
		<div id="divTitle">
			<span id="spanTitle">新用户注册</span>
		</div>
		<div id="divBody" >
			<form action="<c:url value='/sp/regist'/>" method="post"
				id="registForm">
				<table id="tableForm">
					<tr>
						...
						<td>
							<div id="divVerifyCode">
								<img id="imgVerifyCode"
									src="<c:url value='/VerfyCode'/>" />
							</div></td>
						<td><label><a href="javascript:change()">换一张</a>
						</label></td>
					</tr>
					<tr>
						<td></td>
						...
						<td><label></label><a href='<c:url value="/jsps/user/login.jsp"/>'>去登录</a></td>
					</tr>
				</table>
			</form>
		</div>
