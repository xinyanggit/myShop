...
public class CategoryDao implements ICategoryDao {
	...
	private Category toCategory(Map<String,Object> map) {
		...
		String pid = (String)map.get("parentid");// 如果是一级分类，那么pid是null
	...
	public List<Category> findAll() throws SQLException {
		 ...
		 * 1. 查询出所有一级分类
		 */
		String sql = "select * from t_category where parentid is null order by orderBy";
	...
	public List<Category> findByParent(String pid) throws SQLException {
		String sql = "select * from t_category where parentid=? order by orderBy";
	...
	public void add(Category category) throws SQLException {
		String sql = "insert into t_category(cid,cname,parentid,`desc`) values(?,?,?,?)";
		/*
	...
	public void edit(Category category) throws SQLException {
		String sql = "update t_category set cname=?, parentid=?, `desc`=? where cid=?";
		String pid = null;
		if(category.getParent() != null) {
			pid = category.getParent().getCid();
		}
	...
	public int findChildrenCountByParent(String pid) throws SQLException {
		String sql = "select count(*) from t_category where parentid=?";
