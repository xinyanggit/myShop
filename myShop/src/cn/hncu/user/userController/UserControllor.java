package cn.hncu.user.userController;
...
import cn.hncu.user.userService.IUserService;
...
public class UserControllor { 
	...
	public String login(HttpServletRequest req,HttpServletResponse resp,User user) throws UnsupportedEncodingException{
		 ...
		 */
		User user1 = service.login(formUser);
		/*
		 * 4. 开始判断
		 */
		if(user1 == null) {
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value="/ajaxValidateLoginname")
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value="/ajaxValidateEmail")
	...
	public String updatePassword(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			service.updatePassword(user.getUid(), formUser.getNewpass(), 
					formUser.getLoginpass());
			req.setAttribute("msg", "修改密码成功");
			req.setAttribute("code", "success");
			req.setAttribute("yes", true);
			req.getSession().invalidate();
			return "msg";
		} catch (Exception e) {
			req.setAttribute("msg", e.getMessage());//保存异常信 息到request
