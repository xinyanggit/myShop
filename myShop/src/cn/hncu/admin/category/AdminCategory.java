package cn.hncu.admin.category;
...
//		return "f:/adminjsps/admin/category/list.jsp";
	...
	public String addChildPre(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		String parentid = req.getParameter("parentid");//当前点击的父分类id
		List<Category> parents = categoryService.findParents();
		req.setAttribute("parentid", parentid);
		req.setAttribute("parents", parents);
//		return "f:/adminjsps/admin/category/add2.jsp";
		return "add2_admin_category";
	}
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value="/editParentPre")
...
//		return "f:/adminjsps/admin/category/edit.jsp";
	 ...
	 * @throws IOException
	 */
	@RequestMapping(value="/editChildPre")
...
//		return "f:/adminjsps/admin/category/edit2.jsp";
	...
	public String deleteChild(HttpServletRequest req, HttpServletResponse resp)
		...
		String cid = req.getParameter("cid");
		int cnt = phoneService.findPhoneCountByCategory(cid);
		if(cnt > 0){
